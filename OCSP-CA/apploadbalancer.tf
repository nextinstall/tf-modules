resource "aws_lb" "loadbalancer" {
  name               = "${var.env_level}-${var.product}-${var.Environment}-ocsp-lb"
...
resource "aws_route53_record" "ocsp-prod" {
  zone_id = "${data.aws_route53_zone.prod.zone_id}"
  name    = "ocsp-prod.prod.adinfra.huit.harvard.edu"
  type    = "A"
...
resource "aws_lb_target_group" "http" {
  name       = "${var.env_level}-${var.product}-ocsp-http-lb-tg"
