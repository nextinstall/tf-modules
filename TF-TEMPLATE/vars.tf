...
variable "ssl_cert_arn" {
  description ="SSL ARN name from IAM/CERT in AWS"
  default = ""
  
}
variable "lb_dns_record" {
  description ="Name for Route53 record"
  default =""
}

variable "elb_log_s3_bucket"{
  description = "S3 Bucket Name for Acess Logs"
  default = ""
}
...
variable "role" {
  description = "Application role for resource"
  default     = ""
}
